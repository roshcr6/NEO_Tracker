...
class LiveSolarSystem {
    ...
    createSun() {
        ...
        const sunTexture = textureLoader.load('/static/orrery/textures/sun.jpg');
    ...
    createPlanetaryRings(planet, planetKey, planetRadius) {
        ...
        if (planetKey === 'saturn') {
            ...
            ringTexture = '/static/orrery/textures/saturn_ring.png'; // LOCAL high-quality ring texture with gaps!
    ...
    createStarField() {
        ...
        const starTexture = textureLoader.load(
            '/static/orrery/textures/starfield.jpg',
            () => {
